...
cookbook 'elasticsearch', git: 'git://github.com/justanshulsharma/cookbook-elasticsearch.git', branch: 'foodcritic'
...
cookbook 'opsworks_stack_state_sync', git: 'git://github.com/justanshulsharma/opsworks_stack_state_sync', branch: 'elasticsearch'
